L'objectif de cet exercice est de créer une page d'échantillon.

Une page d'échantillon permet, en un coup d'oeil, de se rendre compte des styles génériques attribués aux éléments génériques d'une page web. Il permet de se concentrer sur l'aspect du contenu sans faire attention à son contexte.
...
<fieldset>
   ...
   <form>
      ...
      <p>
         ...
         <label><input type="radio" class="radio" name="radio_button" value="radio_1" /> Radio 1<br/>
         <label><input type="radio" class="radio" name="radio_button" value="radio_2" /> Radio 2<br/>
         <label><input type="radio" class="radio" name="radio_button" value="radio_3" /> Radio 3<br/>
      </p>
      <p><label for="checkboxes">Checkboxes:</label><br />
         <input type="checkbox" class="checkbox" name="checkboxes" value="check_1" /> checkboxes 1<br/>
         <input type="checkbox" class="checkbox" name="checkboxes" value="check_2" /> checkboxes 2<br/>
         <input type="checkbox" class="checkbox" name="checkboxes" value="check_3" /> checkboxes 3<br/>
      </p>
